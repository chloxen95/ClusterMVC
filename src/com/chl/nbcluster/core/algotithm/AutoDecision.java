 ...
 * <p><li>由于该聚类算法只对 <code>rho</code> 的取值敏感，而对 <code>dc</code> 鲁棒，
...
public class AutoDecision {
	 ...
	 * @param dc
	 */
	public AutoDecision(List<Double[]> point, Integer x_upper, Integer x_lower, Integer y_upper,
			Integer y_lower, Double dc) {
		super();
		this.point = point;
	...
	/**
	 * 设置无关点的坐标范围
	 * <p><li>无关点是指在随机边界一定范围 <code>bound_area</code> 内的点
	...
	/**
	 * 自动选择决策边界
	 * <p><li>当没有更好的边界值时，返回原值
	 * <p><li>该算法还未完成，并且没什么卵用
	 * @return 
	 */
